...
class VisitFilter(django_filters.FilterSet):
    ...
    car = django_filters.ModelChoiceFilter(
        queryset=Visit.car.field.related_model.objects.select_related('car_model__car_brand', 'customer'),
        label='Car',
        widget=forms.Select(attrs={'class': 'form-select'})
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.form.helper.layout = Layout(
            Row(
                Column('visit_date__gte', css_class='form-group col-md-6 mb-0'),
                Column('visit_date__lte', css_class='form-group col-md-6 mb-0')
            ),
            Row(
